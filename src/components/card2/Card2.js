...
const Card2 = () => {
  return (
    <div className="Card2 lg:mt-[0px] ">
      <div className="text-[20px] font-[700] text-[#000000] mb-[20px] ml-[80px] sm:text-start lg:text-start md:text-start">
        Reading blog list
      </div>
      <div className="flex justify-between  items-center w-[90%] mx-auto sm:flex sm:flex-col md:flex md:flex-row md:gap-10 md:flex md:flex-col sm:flex sm:flex-col sm:items-center sm:w-100 sm:gap-5 lg:flex-row">
        <div className="flex sm:flex sm:flex-col sm:items-center sm:w-[100%] sm:gap-10 sm:mb-[20px] md:flex-row md:gap-10">
          <div className="w-[100%] ">
